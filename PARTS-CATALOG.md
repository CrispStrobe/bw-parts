...
| 94 | `attiny85` | ATtiny / ATtiny | modeled (avr8js, a7fef9a) | dip-gen | **unverified**: probably ATtiny85 |
| 95 | `microbit` | micro:bit / micro:bit | drawable-only | done | **unverified**: v1 vs v2 |
| 96 | `stc_mcu` | STC12/STC15 MCU / STC-MCU | modeled (emu8051) | dip-gen | unique to bw |
...
| # | Kind slug | Name EN / DE | Terminals | Engine | Art |
|---|-----------|-------------|-----------|--------|-----|
| 97 | `multimeter` | Multimeter / Multimeter | probe_a, probe_b | modeled | done |
| 98 | `power_supply` | Power Supply / Netzteil | pos, neg | modeled | done |
| 99 | `function_gen` | Function Generator / Funktionsgenerator | out, gnd | modeled | done |
| 100 | `oscilloscope` | Oscilloscope / Oszilloskop | ch1, ch2, gnd | modeled | done |
...
|---|-----------|-------------|--------|-----|
| 101 | `breadboard_full` | Breadboard Standard / Steckbrett | drawable-only | done |
| 102 | `breadboard_half` | Breadboard Small / Steckbrett Klein | drawable-only | done |
