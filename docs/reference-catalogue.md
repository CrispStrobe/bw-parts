...
>
> This file is our part-identification work built from a saved copy
> of the Tinkercad Circuits component picker. The identification marks
> (`slug`, `label`, `standard`, `unverified`) and engineering notes
> are ours; the component names come from Tinkercad's UI.
